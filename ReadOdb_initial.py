...
with open(csv_path, 'wb') as csvfile:
    ...
    for particle_number in range(1,41):
        odbPath = directory_path + '/odb/0_' + str(particle_number) + '.odb'
        print odbPath
        odb = openOdb(odbPath)
        ...
        s_resin0 = assembly.surfaces['S:RESIN_3D'] 
        ...
        spamwriter.writerow([str(particle_number), str(Total_Area0)])
